...
# Slightly tweaked version of the .bash_profile gist by Nathaniel Landau at
...
# https://stackoverflow.com/questions/35249881/octave-fontconfig-error/35250118
export FONTCONFIG_PATH="/opt/X11/lib/X11/fontconfig"

# http://stackoverflow.com/questions/16950130/osx-bundler-install-command-not-found
...
showa () { /usr/bin/grep --color=always -i -a1 "$@" ~/.scry-shell/bash_profile.sh | grep -v '^\s*$' | less -FSRXc ; }
...
alias finderShowHidden="finderSetHidden 1"
alias finderHideHidden="finderSetHidden 0"
